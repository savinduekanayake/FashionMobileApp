...
class Place_details extends StatefulWidget {
  ...
  @override
  _Place_detailsState createState() => _Place_detailsState();
}
...
//              ),
          ...
          new ListTile(
            title: Padding(
              ...
              child: new Text("place details"),
            ),

            subtitle: new Text(widget.place_details),
          ),
          ...
          new Row(
            children: <Widget>[
              Padding(padding : const EdgeInsets.fromLTRB(12.0, 5.0, 5.0, 5.0),
                child: new Text("Place name", style: TextStyle(color: Colors.grey),),
              ),
          ...
          new Row(
            children: <Widget>[
              Padding(padding : const EdgeInsets.fromLTRB(12.0, 5.0, 5.0, 5.0),
                child: new Text("Open time :", style: TextStyle(color: Colors.grey),),
              ),
              Padding(padding: EdgeInsets.all(5.0),
                child: new Text(widget.open_time),)
          ...
          new Row(
            children: <Widget>[
              Padding(padding : const EdgeInsets.fromLTRB(12.0, 5.0, 5.0, 5.0),
                child: new Text("Road condition", style: TextStyle(color: Colors.grey),),
              ),

              //     REMAINDER TO add condition
              Padding(padding: EdgeInsets.all(5.0),
                child: new Text(widget.mode_of_access),),
            ],
          ),
